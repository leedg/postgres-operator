...
| F04 | P2 HA / Failover (election + envtest 통합) | 테스트 | 50% | F01 | F03 | M1 도달 — 단위 97.4%, envtest 통합 2종, 운영 가이드, RFC 0003 Implemented |
...
1. F04 P2-M2 — failover controller(P2-T3) + PVC fencing(P2-T2). RFC 0003 부록 A.
2. F05 P3-M1 — PVC 관리 + WAL 아카이빙 + base restore. RFC 작성 선행.
3. F07 P5-M1 — PgBouncer 사이드카 + 독립 Deployment.
4. F08 P6-M1 — exporter + Grafana + PrometheusRule.
5. F02 P10-M1 — extension lifecycle e2e.
